...
namespace code_challenge.Tests.Integration
{
    public class TestServerStartup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, EmployeeDataSeeder seeder, CompensationDataSeeder compSeeder)
        {
